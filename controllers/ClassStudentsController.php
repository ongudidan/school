...
class ClassStudentsController extends Controller
{
     ...
     * @param int $class_student_id Class Students ID
     * @return string
     * @throws NotFoundHttpException if the model cannot be found
     */
    public function actionView($class_student_id)
    {
        return $this->render('view', [
            'model' => $this->findModel($class_student_id),
        ]);
    }
    ...
    public function actionCreate()
    {
        ...
        if ($this->request->isPost) {
            if ($model->load($this->request->post()) && $model->save()) {
                return $this->redirect(['view', 'class_student_id' => $model->class_student_id]);
            }
        } else {
     ...
     * @throws NotFoundHttpException if the model cannot be found
     */
    public function actionUpdate($class_student_id)
    {
        $model = $this->findModel($class_student_id);
     ...
     * @throws NotFoundHttpException if the model cannot be found
     */
    public function actionDelete($class_student_id)
    {
        $this->findModel($class_student_id)->delete();
     ...
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($class_student_id)
    {
        if (($model = ClassStudents::findOne(['class_student_id' => $class_student_id])) !== null) {
            return $model;
        }
